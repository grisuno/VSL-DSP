...
- Symbols:
  - `audiobox_probe` (function, line 37) `static int audiobox_probe(struct usb_interface *intf,
                          const struct usb_...`
  - `audiobox_disconnect` (function, line 59) `static void audiobox_disconnect(struct usb_interface *intf)`
...
- Symbols:
  ...
  - `audiobox_lookup_model` (function, line 96) `static inline const audiobox_model_info_t *
