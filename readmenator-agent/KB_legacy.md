...
- Symbols:
  ...
  - `printf` (function, line 36) `printf("--- Ganancia ---\n");`
  - `VSL_Build_And_Send_Packet` (function, line 68) `VSL_Build_And_Send_Packet(gain_id, encoded_gain_float);`
...
- Symbols:
  ...
  - `snd_usb_mixer_elem_init_std` (function, line 74) `snd_usb_mixer_elem_init_std(&cval->head, mixer, unitid);`
  - `kfree` (function, line 94) `kfree(cval);`
  - `snprintf` (function, line 99) `snprintf(kctl->id.name, sizeof(kctl->id.name), name);`
  - `snd_usb_mixer_add_control` (function, line 110) `return snd_usb_mixer_add_control(&cval->head, kctl);`
  - `snd_usb_mixer_add_list` (function, line 170) `return snd_usb_mixer_add_list(list, kctl, false);`
  - `wake_up` (function, line 217) `wake_up(&mixer->rc_waitq);`
  - `poll_wait` (function, line 244) `poll_wait(file, &mixer->rc_waitq, wait);`
  - `init_waitqueue_head` (function, line 262) `init_waitqueue_head(&mixer->rc_waitq);`
  - `usb_free_urb` (function, line 280) `usb_free_urb(mixer->rc_urb);`
  - `usb_fill_control_urb` (function, line 290) `usb_fill_control_urb(mixer->rc_urb, mixer->chip->dev, usb_rcvctrlpipe(mixer->chip->dev, 0), (u8 *)mixer->rc_setup_packet, mixer->rc_buffer, len, snd_usb_soundblaster_remote_complete, mixer);`
  - `CLASS` (function, line 310) `CLASS(snd_usb_lock, pm)(chip);`
  - `usb_sndctrlpipe` (function, line 328) `usb_sndctrlpipe(chip->dev, 0), 0x24, USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_OTHER, value, index + 2, NULL, 0);`
  - `snd_iprintf` (function, line 429) `snd_iprintf(buffer, "%s jacks\n\n", mixer->chip->card->shortname);`
  - `usb_rcvctrlpipe` (function, line 445) `usb_rcvctrlpipe(mixer->chip->dev, 0), UAC_GET_MEM, USB_DIR_IN | USB_TYPE_CLASS | USB_RECIP_INTERFACE, 0, jacks[i].unitid << 8, buf, 3);`
  - `snd_ctl_enum_info` (function, line 461) `return snd_ctl_enum_info(uinfo, 1, ARRAY_SIZE(texts), texts);`
  - `snd_usb_ctl_msg` (function, line 484) `return snd_usb_ctl_msg(chip->dev, usb_sndctrlpipe(chip->dev, 0), UAC_SET_CUR, USB_RECIP_INTERFACE | USB_TYPE_CLASS | USB_DIR_OUT, 0x0400, 0x0e00, buf, 2);`
  - `snd_ctl_notify` (function, line 566) `snd_ctl_notify(me->mixer->chip->card, SNDRV_CTL_EVENT_MASK_VALUE, &me->kctl->id);`
  - `dev_warn` (function, line 585) `dev_warn(&snd_dev->dev, "Failed to get input dev path\n");`
  - `input_unregister_handle` (function, line 642) `err_unregister: input_unregister_handle(handle);`
  - `input_close_device` (function, line 652) `input_close_device(handle);`
  - `snd_usb_mixer_elem_free` (function, line 710) `snd_usb_mixer_elem_free(kctl);`
  - `strscpy` (function, line 741) `strscpy(kctl->id.name, name, sizeof(kctl->id.name));`
  - `dev_err` (function, line 1134) `dev_err(&dev->dev, "unable to issue vendor read request (ret = %d)", err);`
  - `usb_control_msg` (function, line 1158) `return usb_control_msg(chip->dev, usb_sndctrlpipe(chip->dev, 0), (pval >> 16) & 0xff, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_DIR_OUT, pval >> 24, pval & 0xffff, NULL, 0, 1000);`
  - `snd_usb_ctrl_intf` (function, line 1292) `snd_usb_ctrl_intf(mixer->hostif) | ((pval & 0xff) << 8), value, 2);`
  - `snd_usb_mixer_set_ctl_value` (function, line 1552) `snd_usb_mixer_set_ctl_value(cval, UAC_SET_CUR, cval->control << 8, samplerate_id);`
  - `snd_usb_mixer_notify_id` (function, line 1555) `snd_usb_mixer_notify_id(mixer, unitid);`
  - `BIT` (function, line 1726) `BIT(chan + (chan % 2) * num_outs - 1);`
  - `HDA_VERB_CMD` (function, line 2239) `HDA_VERB_CMD(AC_VERB_GET_PIN_SENSE, node_id, 0), &sense);`
  - `field_get` (function, line 3395) `return field_get(mask, val);`
  - `USB_ID` (function, line 4249) `case USB_ID(0x194f, 0x0101): err = snd_audiobox_vsl_init(mixer);`
  - `snd_card_ro_proc_new` (function, line 4264) `snd_card_ro_proc_new(mixer->chip->card, "audigy2nx", mixer, snd_audigy2nx_proc_read);`
  - `usb_submit_urb` (function, line 4439) `usb_submit_urb(mixer->rc_urb, GFP_ATOMIC);`
  - `usb_audio_dbg` (function, line 4452) `default: usb_audio_dbg(mixer->chip, "memory change in unknown unit %d\n", unitid);`
  ...
  - `usb_audio_info` (function, line 4479) `usb_audio_info(mixer->chip, "applying DragonFly dB scale quirk (0-50 variant)\n");`
  - `snd_audigy2nx_led_info` (macro, line 296) `#define snd_audigy2nx_led_info`
  - `SND_DUALSENSE_JACK_OUT_TERM_ID` (macro, line 539) `#define SND_DUALSENSE_JACK_OUT_TERM_ID`
  - `SND_DUALSENSE_JACK_IN_TERM_ID` (macro, line 541) `#define SND_DUALSENSE_JACK_IN_TERM_ID`
  - `_MAKE_NI_CONTROL` (macro, line 1118) `#define _MAKE_NI_CONTROL(bRequest, wIndex)`
  - `HDA_VERB_CMD` (macro, line 2171) `#define HDA_VERB_CMD(V, N, D)`
  - `REALTEK_HDA_VALUE` (macro, line 2173) `#define REALTEK_HDA_VALUE`
  - `REALTEK_HDA_SET` (macro, line 2175) `#define REALTEK_HDA_SET`
  ...
  - `REALTEK_AUDIO_FUNCTION_GROUP` (macro, line 2180) `#define REALTEK_AUDIO_FUNCTION_GROUP`
  ...
  - `REALTEK_CBJ_CTRL2` (macro, line 2185) `#define REALTEK_CBJ_CTRL2`
  - `REALTEK_JACK_INTERRUPT_NODE` (macro, line 2187) `#define REALTEK_JACK_INTERRUPT_NODE`
  - `REALTEK_MIC_FLAG` (macro, line 2189) `#define REALTEK_MIC_FLAG`
  - `SND_RME_GET_STATUS1` (macro, line 2362) `#define SND_RME_GET_STATUS1`
  ...
  - `SND_BBFPRO_CTL_REG_MASK` (macro, line 2743) `#define SND_BBFPRO_CTL_REG_MASK`
  ...
  - `SND_BBFPRO_MIXER_MAIN_OUT_CH_OFFSET` (macro, line 2760) `#define SND_BBFPRO_MIXER_MAIN_OUT_CH_OFFSET`
  ...
  - `SND_BBFPRO_GAIN_CHANNEL_MASK` (macro, line 2767) `#define SND_BBFPRO_GAIN_CHANNEL_MASK`
  ...
  - `SND_BBFPRO_USBREQ_CTL_REG1` (macro, line 2774) `#define SND_BBFPRO_USBREQ_CTL_REG1`
  ...
  - `RME_DIGIFACE_READ_STATUS` (macro, line 3297) `#define RME_DIGIFACE_READ_STATUS`
  ...
  - `RME_DIGIFACE_CTL_REG1` (macro, line 3307) `#define RME_DIGIFACE_CTL_REG1`
  ...
  - `SND_DJM_WINDEX_CAP` (macro, line 3744) `#define SND_DJM_WINDEX_CAP`
  ...
  - `SND_DJM_CTL` (macro, line 3766) `#define SND_DJM_CTL(_name, suffix, _default_value, _windex)`
  - `SND_DJM_DEVICE` (macro, line 3773) `#define SND_DJM_DEVICE(suffix)`
...
- Symbols:
  ...
  - `printf` (function, line 8) `printf("Intentando conectar al dispositivo VSL %04X:%04X...\n", VSL_VENDOR_ID, VSL_PRODUCT_ID);`
  - `VSL_Close_Device` (function, line 19) `VSL_Close_Device();`
...
- Symbols:
  ...
  - `VSL_PACKET_SIZE` (macro, line 24) `#define VSL_PACKET_SIZE`
...
- Symbols:
  ...
  - `exp2f` (function, line 46) `return exp2f(log2_value);`
...
- Symbols:
  ...
  - `fprintf` (function, line 28) `fprintf(stderr, "Error: HIDAPI init failed\n");`
  - `hid_free_enumeration` (function, line 49) `hid_free_enumeration(devs);`
  - `free` (function, line 55) `free(target_path);`
  - `hid_exit` (function, line 62) `hid_exit();`
  - `printf` (function, line 65) `printf("VSL Device handle opened successfully via path: %04X:%04X\n", vendor_id, product_id);`
  - `hid_close` (function, line 72) `hid_close(vsl_device_handle);`
  - `memcpy` (function, line 121) `memcpy(&buf[1], &net_id, sizeof(uint16_t));`
- Depends on: `legacy/vsl_config.h`, `legacy/vsl_dsp_transport.h`
