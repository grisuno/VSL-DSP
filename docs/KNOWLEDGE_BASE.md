...
**Total Files Parsed:** 27 | **Total Symbols Extracted:** 420 | **Total Imports:** 107
...
**Functions:**
- `audiobox_probe` (line 36)
- `audiobox_disconnect` (line 58)
...
**Functions:**
- `main` (line 4) - *include <stdio.h> include "vsl_dsp_logic.h" include "vsl_dsp_transport.h"*

#### `mixer_quirks.c`
**Path:** `legacy/mixer_quirks.c`

**Functions:**
- `snd_create_std_mono_ctl_offset` (line 59) - *This function allows for the creation of standard UAC controls. See the quirks for M-Audio FTUs or Ebox-44. If you don't want to set a TLV callback...*
- `snd_create_std_mono_ctl` (line 112)
- `snd_create_std_mono_table` (line 129) - *Create a set of standard UAC controls from a table*
- `add_single_ctl_with_resume` (line 145)
- `snd_usb_soundblaster_remote_complete` (line 199)
- `snd_usb_sbrc_hwdep_read` (line 219)
- `snd_usb_sbrc_hwdep_poll` (line 239)
- `snd_usb_soundblaster_remote_init` (line 248)
- `snd_audigy2nx_led_get` (line 298) - *define snd_audigy2nx_led_info		snd_ctl_boolean_mono_info*
- `snd_audigy2nx_led_update` (line 304)
- `snd_audigy2nx_led_put` (line 333)
- `snd_audigy2nx_led_resume` (line 352)
- `snd_audigy2nx_controls_create` (line 374)
- `snd_audigy2nx_proc_read` (line 406)
- `snd_emu0204_ch_switch_info` (line 457) - *return; err = snd_usb_ctl_msg(mixer->chip->dev, usb_rcvctrlpipe(mixer->chip->dev, 0), UAC_GET_MEM, USB_DIR_IN | USB_TYPE_CLASS | USB_RECIP_INTERFAC...*
- `snd_emu0204_ch_switch_get` (line 464)
- `snd_emu0204_ch_switch_update` (line 471)
- `snd_emu0204_ch_switch_put` (line 489)
- `snd_emu0204_ch_switch_resume` (line 508)
- `snd_emu0204_controls_create` (line 523)
- `snd_dualsense_ih_event` (line 549)
- `snd_dualsense_ih_match` (line 570)
- `snd_dualsense_ih_connect` (line 617)
- `snd_dualsense_ih_disconnect` (line 649)
- `snd_dualsense_ih_start` (line 656)
- `snd_dualsense_jack_get` (line 679)
- `snd_dualsense_resume_jack` (line 696)
- `snd_dualsense_mixer_elem_free` (line 703)
- `snd_dualsense_jack_create` (line 713)
- `snd_dualsense_controls_create` (line 777)
- `snd_xonar_u1_switch_get` (line 791) - *static int snd_dualsense_controls_create(struct usb_mixer_interface *mixer) { int err;  err = snd_dualsense_jack_create(mixer, "Headphone Jack", tr...*
- `snd_xonar_u1_switch_update` (line 798)
- `snd_xonar_u1_switch_put` (line 812)
- `snd_xonar_u1_switch_resume` (line 832)
- `snd_xonar_u1_controls_create` (line 847)
- `snd_mbox1_is_spdif_synced` (line 856) - *.info = snd_ctl_boolean_mono_info, .get = snd_xonar_u1_switch_get, .put = snd_xonar_u1_switch_put, .private_value = 0x05, };  static int snd_xonar_...*
- `snd_mbox1_set_clk_source` (line 876)
- `snd_mbox1_is_spdif_input` (line 894)
- `snd_mbox1_set_input_source` (line 914)
- `snd_mbox1_clk_switch_get` (line 933) - *S/PDIF Source  -> 0x02  unsigned char buff[1];  buff[0] = (is_spdif & 1) + 1;  /* Set input source return snd_usb_ctl_msg(chip->dev, usb_sndctrlpip...*
- `snd_mbox1_clk_switch_update` (line 953)
- `snd_mbox1_clk_switch_put` (line 978)
- `snd_mbox1_clk_switch_info` (line 996)
- `snd_mbox1_clk_switch_resume` (line 1007)
- `snd_mbox1_src_switch_get` (line 1014) - *static const char *const texts[2] = { "Internal", "S/PDIF" };  return snd_ctl_enum_info(uinfo, 1, ARRAY_SIZE(texts), texts); }  static int snd_mbox...*
- `snd_mbox1_src_switch_update` (line 1021)
- `snd_mbox1_src_switch_put` (line 1045)
- `snd_mbox1_src_switch_info` (line 1063)
- `snd_mbox1_src_switch_resume` (line 1074)
- `snd_mbox1_controls_create` (line 1101)
- `snd_ni_control_init_val` (line 1120) - *err = add_single_ctl_with_resume(mixer, 0, snd_mbox1_clk_switch_resume, &snd_mbox1_clk_switch, NULL); if (err < 0) return err;  return add_single_c...*
- `snd_nativeinstruments_control_get` (line 1142)
- `snd_ni_update_cur_val` (line 1149)
- `snd_nativeinstruments_control_put` (line 1163)
- `snd_nativeinstruments_create_mixer` (line 1234)
- `snd_ftu_eff_switch_info` (line 1267) - *err = add_single_ctl_with_resume(mixer, 0, snd_ni_update_cur_val, &template, &list); if (err < 0) break; snd_ni_control_init_val(mixer, list->kctl)...*
- `snd_ftu_eff_switch_init` (line 1277)
- `snd_ftu_eff_switch_get` (line 1300)
- `snd_ftu_eff_switch_update` (line 1307)
- `snd_ftu_eff_switch_put` (line 1328)
- `snd_ftu_create_effect_switch` (line 1346)
- `snd_ftu_create_volume_ctls` (line 1373) - *struct usb_mixer_elem_list *list; int err;  err = add_single_ctl_with_resume(mixer, bUnitID, snd_ftu_eff_switch_update, &template, &list); if (err ...*
- `snd_ftu_create_effect_volume_ctl` (line 1412) - *"DIn%d - Out%d Playback Volume", in - 7, out + 1); err = snd_create_std_mono_ctl(mixer, id, control, cmask, val_type, name, &snd_usb_mixer_vol_tlv)...*
- `snd_ftu_create_effect_duration_ctl` (line 1425) - */* This control needs a volume quirk, see mixer.c static int snd_ftu_create_effect_volume_ctl(struct usb_mixer_interface *mixer) { static const cha...*
- `snd_ftu_create_effect_feedback_ctl` (line 1438) - */* This control needs a volume quirk, see mixer.c static int snd_ftu_create_effect_duration_ctl(struct usb_mixer_interface *mixer) { static const c...*
- `snd_ftu_create_effect_return_ctls` (line 1449)
- `snd_ftu_create_effect_send_ctls` (line 1473)
- `snd_ftu_create_mixer` (line 1506)
- `snd_emuusb_set_samplerate` (line 1541)
- `list_for_each_entry` (line 1548) - *err = snd_ftu_create_effect_send_ctls(mixer); if (err < 0) return err;  return 0; }  void snd_emuusb_set_samplerate(struct snd_usb_audio *chip, uns...*
- `snd_c400_create_vol_ctls` (line 1563) - *list_for_each_entry(mixer, &chip->mixer_list, list) { if (mixer->id_elems[unitid]) { cval = mixer_elem_list_to_info(mixer->id_elems[unitid]); snd_u...*
- `snd_c400_create_effect_volume_ctl` (line 1612) - *cmask = (out == 0) ? 0 : BIT(out - 1); offset = chan * num_outs; err = snd_create_std_mono_ctl_offset(mixer, id, control, cmask, val_type, offset, ...*
- `snd_c400_create_effect_duration_ctl` (line 1625) - */* This control needs a volume quirk, see mixer.c static int snd_c400_create_effect_volume_ctl(struct usb_mixer_interface *mixer) { static const ch...*
- `snd_c400_create_effect_feedback_ctl` (line 1638) - */* This control needs a volume quirk, see mixer.c static int snd_c400_create_effect_duration_ctl(struct usb_mixer_interface *mixer) { static const ...*
- `snd_c400_create_effect_vol_ctls` (line 1649)
- `snd_c400_create_effect_ret_vol_ctls` (line 1694)
- `snd_c400_create_mixer` (line 1736)
- `snd_microii_spdif_info` (line 1869) - *power on values: r2: 0x10 r3: 0x20 (b7 is zeroed just before playback (except IEC61937) and set just after it to 0xa0, presumably it disables/mutes...*
- `snd_microii_spdif_default_get` (line 1876)
- `snd_microii_spdif_default_update` (line 1923)
- `snd_microii_spdif_default_put` (line 1959)
- `snd_microii_spdif_mask_get` (line 1987)
- `snd_microii_spdif_switch_get` (line 1998)
- `snd_microii_spdif_switch_update` (line 2006)
- `snd_microii_spdif_switch_put` (line 2025)
- `snd_microii_controls_create` (line 2067)
- `snd_soundblaster_e1_switch_get` (line 2090) - *for (i = 0; i < ARRAY_SIZE(snd_microii_mixer_spdif); ++i) { err = add_single_ctl_with_resume(mixer, 0, resume_funcs[i], &snd_microii_mixer_spdif[i]...*
- `snd_soundblaster_e1_switch_update` (line 2097)
- `snd_soundblaster_e1_switch_put` (line 2115)
- `snd_soundblaster_e1_switch_resume` (line 2129)
- `snd_soundblaster_e1_switch_info` (line 2135)
- `snd_soundblaster_e1_switch_create` (line 2154)
- `realtek_hda_set` (line 2191) - *define REALTEK_MANUAL_MODE	72 define REALTEK_HDA_GET_OUT	88 define REALTEK_HDA_GET_IN	89 define REALTEK_AUDIO_FUNCTION_GROUP	0x01 define REALTEK_LI...*
- `realtek_hda_get` (line 2201)
- `realtek_ctl_connector_get` (line 2222)
- `realtek_resume_jack` (line 2272)
- `realtek_add_jack` (line 2279)
- `dell_dock_mixer_create` (line 2306)
- `dell_dock_init_vol` (line 2338)
- `dell_dock_mixer_init` (line 2350)
- `snd_rme_read_value` (line 2418)
- `snd_rme_get_status1` (line 2437)
- `snd_rme_rate_get` (line 2449)
- `snd_rme_sync_state_get` (line 2483)
- `snd_rme_spdif_if_get` (line 2513)
- `snd_rme_spdif_format_get` (line 2526)
- `snd_rme_sync_source_get` (line 2539)
- `snd_rme_current_freq_get` (line 2552)
- `snd_rme_rate_info` (line 2578)
- `snd_rme_sync_state_info` (line 2598)
- `snd_rme_spdif_if_info` (line 2609)
- `snd_rme_spdif_format_info` (line 2620)
- `snd_rme_sync_source_info` (line 2631)
- `snd_rme_controls_create` (line 2713)
- `snd_bbfpro_ctl_update` (line 2779) - *define SND_BBFPRO_MIXER_VAL_MIN 0 // -inf define SND_BBFPRO_MIXER_VAL_MAX 65536 // +6dB define SND_BBFPRO_GAIN_CHANNEL_MASK 0x03 define SND_BBFPRO_...*
- `snd_bbfpro_ctl_get` (line 2810)
- `snd_bbfpro_ctl_info` (line 2833)
- `snd_bbfpro_ctl_put` (line 2867)
- `snd_bbfpro_ctl_resume` (line 2906)
- `snd_bbfpro_gain_update` (line 2919)
- `snd_bbfpro_gain_get` (line 2943)
- `snd_bbfpro_gain_info` (line 2952)
- `snd_bbfpro_gain_put` (line 2973)
- `snd_bbfpro_gain_resume` (line 3010)
- `snd_bbfpro_vol_update` (line 3023)
- `snd_bbfpro_vol_get` (line 3049)
- `snd_bbfpro_vol_info` (line 3057)
- `snd_bbfpro_vol_put` (line 3067)
- `snd_bbfpro_vol_resume` (line 3095)
- `snd_bbfpro_ctl_add` (line 3132)
- `snd_bbfpro_gain_add` (line 3146)
- `snd_bbfpro_vol_add` (line 3158)
- `snd_bbfpro_controls_create` (line 3170)
- `snd_rme_digiface_write_reg` (line 3318) - *#define RME_DIGIFACE_STATUS_REG2H 5 #define RME_DIGIFACE_STATUS_REG3L 6 #define RME_DIGIFACE_STATUS_REG3H 7  #define RME_DIGIFACE_CTL_REG1 16 #defi...*
- `snd_rme_digiface_read_status` (line 3336)
- `snd_rme_digiface_get_status_val` (line 3360)
- `snd_rme_digiface_rate_get` (line 3398)
- `snd_rme_digiface_enum_get` (line 3412)
- `snd_rme_digiface_enum_put` (line 3424)
- `snd_rme_digiface_current_sync_get` (line 3438)
- `snd_rme_digiface_sync_state_get` (line 3450)
- `snd_rme_digiface_format_info` (line 3473)
- `snd_rme_digiface_sync_source_info` (line 3484)
- `snd_rme_digiface_rate_info` (line 3495)
- `snd_rme_digiface_controls_create` (line 3684)
- `snd_djm_get_label_caplevel_common` (line 3791)
- `snd_djm_get_label_caplevel_high` (line 3804) - *Models like DJM-A9 or DJM-V10 have different capture levels than others*
- `snd_djm_get_label_cap_common` (line 3816)
- `snd_djm_get_label_cap_850` (line 3849) - *The DJM-850 has different values for CD/LINE and LINE capture control options than the other DJM declared in this file.*
- `snd_djm_get_label_caplevel` (line 3857)
- `snd_djm_get_label_cap` (line 3866)
- `snd_djm_get_label_pb` (line 3874)
- `snd_djm_get_label` (line 3884)
- `snd_djm_controls_info` (line 4116)
- `snd_djm_controls_update` (line 4148)
- `snd_djm_controls_get` (line 4169)
- `snd_djm_controls_put` (line 4176)
- `snd_djm_controls_resume` (line 4193)
- `snd_djm_controls_create` (line 4203)
- `snd_usb_mixer_apply_create_quirk` (line 4238)
- `snd_usb_mixer_resume_quirk` (line 4420)
- `snd_usb_mixer_rc_memory_change` (line 4429)
- `snd_dragonfly_quirk_db_scale` (line 4457)
- `snd_fix_plt_name` (line 4509) - *standards. This function fixes nonstandard source names. By the time this function is called the control name should look like one of these: "sourc...*
- `snd_usb_mixer_fu_apply_quirk` (line 4538)
...
**Structs:**
- `std_mono_table` (line 45) - *include <sound/info.h> include <sound/tlv.h> include "usbaudio.h" include "mixer.h" include "mixer_quirks.h" include "audiobox_vsl.h" include "mixe...*
...
- `sb_jack` (line 410)
- `dualsense_mixer_elem_info` (line 543) - *Sony DualSense controller (PS5) jack detection  Since this is an UAC 1 device, it doesn't support jack detection. However, the controller hid-plays...*
...
**Functions:**
- `main` (line 6) - *test_connection.c include <stdio.h> include "vsl_config.h" include "vsl_dsp_transport.h" // Asumiendo que esta es la plantilla B*

#### `vsl_dsp_logic.c`
**Path:** `legacy/vsl_dsp_logic.c`

**Functions:**
- `VSL_Encode_Gain` (line 11) - *========================================================================= FUNCIONES DE CODIFICACIÓN (Enviar al DSP) ===============================...*
- `VSL_Map_Frequency` (line 29) - *Implementación de FUN_00132d00*
- `VSL_Final_Encode_To_Int` (line 58) - *@brief Convierte el valor codificado en float a un entero sin signo para el firmware. @note Basado en la hipótesis común de DSP donde el rango flot...*
- `VSL_Decode_Frequency` (line 78) - *========================================================================= FUNCIONES DE DECODIFICACIÓN (Leer del DSP) ==============================...*

#### `vsl_dsp_transport.c`
**Path:** `legacy/vsl_dsp_transport.c`

**Functions:**
- `VSL_Init_Device` (line 22) - *======================================================= IMPLEMENTACIÓN DE TRANSPORTE FALTANTE =====================================================...*
- `VSL_Close_Device` (line 69)
- `VSL_Get_Device_Handle` (line 78)
- `FUN_Send_Packet` (line 97) - *@brief Función de I/O real usando HIDAPI. @note DEBE SER REEMPLAZADA con la lógica específica de tu dispositivo (Report ID, longitud, etc.)*
- `VSL_Build_And_Send_Packet` (line 140) - *Implementación de la función de construcción y envío*
...
**Functions:**
- `VSL_Init_Device` (line 6) - *#include "vsl_dsp_transport.h" #include <stdio.h> #include <stdlib.h>  /* Stub implementation for HID transport - to be replaced with real HIDAPI code*
- `VSL_Close_Device` (line 12)
- `VSL_Send_Parameter` (line 17)

#### `test_audiobox_vsl.c`
**Path:** `tests/test_audiobox_vsl.c`

**Functions:**
- `test_supported_models_table_shape` (line 30)
- `test_model_pids_match_table` (line 45)
- `test_lookup_returns_22_vsl` (line 54)
- `test_lookup_returns_44_vsl` (line 64)
- `test_lookup_returns_1818_vsl` (line 74)
- `test_lookup_returns_null_for_unknown_pid` (line 84)
- `test_lookup_handles_full_pid_range` (line 94)
- `test_table_pids_are_unique` (line 114)
- `test_table_product_names_non_empty` (line 125)
- `main` (line 135)
...
**Functions:**
- `test_VSL_Encode_Gain` (line 8) - *include <stdarg.h> include <stddef.h> include <setjmp.h> include <cmocka.h> include <math.h> include <float.h> include "vsl_dsp_logic.h"*
- `test_VSL_Map_Frequency` (line 35)
- `test_VSL_Decode_Frequency` (line 67)
- `test_VSL_Final_Encode_To_Int` (line 99)
- `main` (line 127)
...
**Functions:**
- `audiobox_lookup_model` (line 95) - *@brief Look up the model info entry for a given USB product ID.  @param pid 16-bit product ID reported by the USB device. @return Pointer to a cons...*
...
**Structs:**
- `usb_mixer_interface` (line 113) - *ifdef __KERNEL__ include <linux/usb.h> include <sound/core.h>*
...
**Classs:**
- `VSLParameter` (line 40) - *Estructura que replica exactamente VSL_Parameter del código C.
Todos los campos están confirmados del desensamblado.*

**Functions:**
- `validate_configuration` (line 92) - *Valida que todos los valores críticos estén configurados.

Returns:
    (is_valid, error_message)*
- `print_configuration_status` (line 116) - *Imprime el estado de la configuración con formato.*

#### `vsl_core.py`
**Path:** `legacy/vsl_core.py`

**Functions:**
- `vsl_encode_gain` (line 16) - *Traducción de FUN_00132c90 (VSL_Encode_Gain en C).
...
- `vsl_map_frequency` (line 58) - *Traducción de FUN_00132d00 (VSL_Map_Frequency en C).
...
- `vsl_final_encode_to_int` (line 94) - *Traducción de VSL_Final_Encode_To_Int en C.
...
- `vsl_decode_frequency` (line 127) - *Traducción de FUN_00132da8 (VSL_Decode_Frequency en C).
...
Raises:
    ValueError: Si las frecuencias son inválidas*
- `validate_parameter` (line 170) - *Valida la integridad de un VSLParameter.
...
**Classs:**
- `VSLDevice` (line 31) - *Gestor de dispositivo VSL-DSP con patrón Singleton.
Maneja la conexión HID y envío de paquetes.*

**Functions:**
- `enumerate_vsl_devices` (line 149) - *Enumera todos los dispositivos HID conectados.
Útil para descubrir VID/PID del hardware.*
- `__new__` (line 39)
- `__init__` (line 45)
- `open` (line 59) - *Abre la conexión con el dispositivo VSL.

Returns:
    True si la conexión fue exitosa, False en caso contrario*
- `close` (line 90) - *Cierra la conexión con el dispositivo.*
- `send_packet` (line 101) - *Envía un paquete VSL al dispositivo.
...
- `__enter__` (line 139) - *Context manager entry.*
- `__exit__` (line 144) - *Context manager exit.*

#### `vsl_poc_main.py`
**Path:** `legacy/vsl_poc_main.py`

**Functions:**
- `test_gain_encoding` (line 43) - *Test de codificación de ganancia con tabla de validación.*
- `test_frequency_mapping` (line 72) - *Test de mapeo logarítmico de frecuencias.*
- `test_packet_construction` (line 92) - *Test de construcción de paquetes HID.*
- `test_edge_cases` (line 150) - *Test de casos extremos y validación de errores.*
- `run_full_workflow` (line 197) - *Simula el flujo completo: Usuario → Encoding → Paquete.*
- `print_summary` (line 229) - *Imprime resumen del estado del proyecto.*
- `main` (line 266) - *Función principal de la PoC.*

#### `vsl_protocol_analyzer.py`
**Path:** `legacy/vsl_protocol_analyzer.py`

**Classs:**
- `VSLParameter` (line 28) - *Parámetros DSP descifrados con coeficientes y rangos.*

**Functions:**
- `reverse_map_gain` (line 67) - *Simula VSL_Decode_Gain. Convierte un entero a un valor de usuario (dB).
...
- `reverse_map_frequency` (line 95) - *Simula VSL_Decode_Frequency. Convierte un entero a frecuencia (Hz).

Fórmula inversa: exp2f(log2_min + pos * (log2_max - log2_min))*
- `get_decoded_value` (line 115) - *Dirige la decodificación al motor DSP correcto.*
- `decode_vsl_packet` (line 140) - *Decodifica el payload de 64 bytes. (Regla #3: Seguridad)*
- `analyze_pcap` (line 173) - *Carga un archivo PCAP y filtra los paquetes USB VSL.*
- `__init__` (line 30)
...
**Classs:**
- `VSLPacket` (line 15) - *Representa un paquete HID VSL-DSP de 64 bytes.
Implementa construcción y validación con seguridad de tipos.*

**Functions:**
- `build_packet_safe` (line 141) - *Construye un paquete con manejo de errores.
...
- `__init__` (line 21) - *Construye un paquete VSL-DSP.
...
- `_build_buffer` (line 58) - *Construye el buffer de 64 bytes según el protocolo VSL-DSP.
...
- `buffer` (line 89) - *Retorna el buffer como bytes inmutables.*
- `hex_dump` (line 93) - *Genera un hex dump del paquete para debugging.
...
- `validate` (line 106) - *Valida la integridad del paquete.
...
**Functions:**
- `print_header` (line 40) - *============================================================================ FUNCTIONS ============================================================...*
