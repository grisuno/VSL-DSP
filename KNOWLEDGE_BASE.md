...
- `vc_alsa.c` <-> `vc_wav.c` (6 hops, across 4 communities)
- `vc_fft.c` <-> `vc_wav.c` (6 hops, across 5 communities)
- `vc_rt.c` <-> `vc_wav.c` (6 hops, across 5 communities)
- `vc_stft.c` <-> `vc_wav.c` (6 hops, across 2 communities)
- `vc_stream.c` <-> `vc_wav.c` (6 hops, across 5 communities)
...
- Why are vc_alsa.c and vc_wav.c connected through 6 hops across 4 communities?
...
graph TD
    ...
    subgraph community_8 ["voicecloak/src"]
